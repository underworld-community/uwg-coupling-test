...
outputPath = "op_SedimentTest_" + op_case_name + "yres{:n}_uwg_Eulerain".format(yRes)
...
if use_coupling:
    Model.surfaceProcesses = GEO.surfaceProcesses.Badlands(airIndex=[materialA.index],sedimentIndex=sediment.index,XML="badlands.xml", resolution=0.5 * u.kilometre, checkpoint_interval=250*u.year,aspectRatio2d=0.25,surfElevation=surf_fn)
