...
# https://github.com/underworldcode/underworld2/blob/main/docs/UWGeodynamics/tutorials/Tutorial_10_Thrust_Wedges.ipynb
...
outputPath = "op_Wedge_FreeSurfEulerian_yres{:n}_uwg_tm".format(yRes)
