...
outputPath = "op_Ex_Thieulot2D_uwg_zres{:n}_cmfix".format(zRes)
...
Model.surfaceProcesses = Badlands(airIndex=[air.index],sedimentIndex=sediment.index,XML="badlands.xml", resolution=2. * u.kilometre, checkpoint_interval=10*u.kiloyear,aspectRatio2d=0.25)
